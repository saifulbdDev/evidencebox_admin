...
import { useUpdateRelationTypeMutation } from '@/features/relationtype/relationtypeApi';
import Input from '@/components/ui/Input';
import Button from '@/components/ui/Buttons/Button';

type UpdateRelationTypeProps = {
  open: boolean;
  onClose: () => void;
  updateData: RelationType;
};

const UpdateRelationType = ({ open, onClose, updateData }: UpdateRelationTypeProps) => {
  const [addRelationType, { isLoading }] = useUpdateRelationTypeMutation();
  ...
  return (
    <Drawer className="max-w-md" title="Update relation name" open={open} onClose={onClose}>
      <Formik
